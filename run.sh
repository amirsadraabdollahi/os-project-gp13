...
echo -e "\n\n";
echo "Testing multi user1";

./test-fs.x multiuseradd our_driver file.txt

#for i in `seq 1 5`; do
#    ./test-fs.x add our_driver file${i}.txt &
#    pids[${i}]=$!
#done
#
## wait for all pids
...
#rm our_add1.txt our_add2.txt our_add3.txt ref_add1.txt ref_add2.txt ref_add3.txt ref_add4.txt ref_add5.txt;

./test-fs.x ls our_driver
